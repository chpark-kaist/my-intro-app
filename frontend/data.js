...
(() => {
  ...
  window.TRIPS = [
    { id: "okinawa", year: 2017, place: "오키나와", country: "일본", lat: 26.21, lon: 127.68, tag: "여행",
      media: [I("okinawa-boat", "배 위에서 하늘을 올려다보는 모습")] },
    { id: "kenting", year: 2017, place: "컨딩", country: "대만", lat: 22.0, lon: 120.8, tag: "여행",
      media: [V("taiwan-beach", "파라솔이 늘어선 해변 풍경"), I("taiwan-beach", "해변을 배경으로 놓인 맥주 두 병")] },
    { id: "mongolia", year: 2018, place: "몽골", country: "몽골", lat: 45.0, lon: 105.0, tag: "여행",
      media: [
    ...
    { id: "osaka", year: 2018, place: "오사카", country: "일본", lat: 34.69, lon: 135.5, tag: "여행",
      media: [I("osaka-wheel", "붉게 빛나는 대관람차 야경"), I("osaka-night", "창밖 야경을 배경으로 한 셀카")] },
    { id: "tokyo", year: 2019, place: "도쿄", country: "일본", lat: 35.68, lon: 139.76, tag: "여행",
      media: [I("tokyo-shoebill", "넓적부리황새"), I("tokyo-gorilla", "수건을 뒤집어쓴 고릴라"), I("tokyo-ramen", "라멘 가게 입구")] },
    { id: "thailand", year: 2019, place: "방콕 · 칸차나부리", country: "태국", lat: 13.75, lon: 100.5, tag: "여행",
      media: [I("th-glass", "유리 바닥 전망대에서"), I("th-erawan", "국립공원 숲길의 안내 표지판")] },
    { id: "hoian", year: 2022, place: "다낭 · 호이안", country: "베트남", lat: 15.95, lon: 108.3, tag: "여행",
      media: [I("vn-flood", "물이 찬 거리에서 브이를 하는 모습")] },
    { id: "fukuoka", year: 2024, place: "후쿠오카", country: "일본", lat: 33.59, lon: 130.4, tag: "여행",
      media: [V("kyushu-train", "건널목을 지나는 붉은 열차"), I("fk-hotpot", "보글보글 끓는 전골")] },
    { id: "bali", year: 2024, place: "발리", country: "인도네시아", lat: -8.65, lon: 115.17, tag: "여행",
      media: [I("bali-crossfit", "크로스핏 체육관 간판 앞에서")] },
    { id: "jeju", year: 2026, place: "제주", country: "한국", lat: 33.45, lon: 126.55, tag: "자전거",
      media: [
